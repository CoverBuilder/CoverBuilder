...
function exportJPG(myPresets){
	...
	jpgpref.jpegRenderingStyle			= JPEGOptionsFormat.BASELINE_ENCODING;	//So much better
	...
	switch (myPresets.kind) {
		case "HR":
			HR_IMG = 300;
			jpgpref.jpegQuality 		= JPEGOptionsQuality.MAXIMUM; // low medium high maximum
			break;
		case "LR":
			HR_IMG = 100;
			jpgpref.jpegQuality 		= JPEGOptionsQuality.HIGH; // low medium high maximum
			break;
	}
